                ...
                <div v-for="(item,index) in components">
                        ...
                        <div @mousedown="mouseDown" draggable="true" v-on:dragstart="movestart"
                            ...
                            <div class="wf-componentview">
                                <div class="wf-componentview-border"><label
                                    class="wf-componentview-label">{{item.defaultLabel}}</label><span
                    ...
                    <div v-if="item.componentName=='selectfield'">
                        <div @mousedown="mouseDown" draggable="true" v-on:dragstart="movestart"
                             ...
                             :data-index="index"
                             v-bind:class="index==selected?'active':''"
                             class="wf-component wf-component-selectfield">
                            <div class="wf-remove icon icon-close" @click="close"></div>
                            <div class="wf-overlay"></div>
                            <div class="wf-componentview">
                                <div class="wf-componentview-border"><label
                    ...
                    <div v-if="item.componentName=='multiselectfield'">
                        <div @mousedown="mouseDown" draggable="true" v-on:dragstart="movestart"
                             ...
                             :data-index="index"
                             v-bind:class="index==selected?'active':''"
                             class="wf-component wf-component-multiselectfield">
                            <div class="wf-remove icon icon-close" @click="close"></div>
                            <div class="wf-overlay"></div>
                            <div class="wf-componentview">
                                <div class="wf-componentview-border"><label
                    ...
                    <div v-if="item.componentName=='datefield'">
                        <div @mousedown="mouseDown" draggable="true" v-on:dragstart="movestart"
                             ...
                             :data-index="index"
                             v-bind:class="index==selected?'active':''"
                             class="wf-component wf-component-datefield">
                            <div class="wf-remove icon icon-close" @click="close"></div>
                            <div class="wf-overlay"></div>
                            <div class="wf-componentview">
                                <div class="wf-componentview-border"><label
                    ...
                    <div v-if="item.componentName=='daterangefield'">
                        <div @mousedown="mouseDown" draggable="true" v-on:dragstart="movestart"
                             ...
                             :data-index="index"
                             v-bind:class="index==selected?'active':''"
                             class="wf-component wf-component-daterangefield">
                            <div class="wf-remove icon icon-close" @click="close"></div>
                            <div class="wf-overlay"></div>
                            <div class="wf-componentview">
                                <div class="wf-componentview-border"><label
                                ...
                                <div class="wf-componentview-border"><label
                                    class="wf-componentview-label">{{item.defaultLabel2}}</label><span
                    ...
                    <div v-if="item.componentName=='photofield'">
                        <div @mousedown="mouseDown" draggable="true" v-on:dragstart="movestart"
                             ...
                             :data-index="index"
                             v-bind:class="index==selected?'active':''"
                             class="wf-component wf-component-photofield">
                            <div class="wf-remove icon icon-close" @click="close"></div>
                            <div class="wf-overlay"></div>
                            <div class="wf-componentview">
                                <div class="wf-componentview-border"><label
                    ...
                    <div v-if="item.componentName=='tablefield'">
                        <div @mousedown="mouseDown" draggable="true" v-on:dragstart="movestart"
                            ...
                            <div class="wf-overlay"></div>
                            <div class="wf-componentview">
                                <label class="wf-componentview-label">{{item.defaultLabel}}</label>
                                        ...
                                        <div v-for="(itemInTable,idx) in item.components">
                                            <div v-if="itemInTable.componentName=='textareafield'">
                                                <div @mousedown="mouseDown" draggable="true" v-on:dragstart="movestart"
                                                    ...
                                                    <div class="wf-componentview">
                                                        <div class="wf-componentview-border"><label
                                                            class="wf-componentview-label">{{itemInTable.defaultLabel}}</label><span
                                            ...
                                            <div v-if="itemInTable.componentName=='daterangefield'">
                                                <div @mousedown="mouseDown" draggable="true" v-on:dragstart="movestart"
                                                     v-on:mouseout="mouseOut"
                                                     v-on:mouseover="hover"
                                                     :data-index="idx"
                                                    ...
                                                    <div class="wf-componentview">
                                                        ...
                                                        <div class="wf-componentview-border"><label
                                                            class="wf-componentview-label">{{itemInTable.defaultLabel2}}</label><span
                                            ...
                                            <div v-if="itemInTable.componentName=='attachmentfield'">
                                                <div @mousedown="mouseDown" draggable="true" v-on:dragstart="movestart"
                                                     v-on:mouseout="mouseOut"
                                                     v-on:mouseover="hover"
                                                     :data-index="idx"
                                                     v-bind:class="idx==item.selected?'active':''"
                                                     class="wf-component wf-component-attachmentfield">
                                                    <div class="wf-remove icon icon-close" @click="close"></div>
                                                    <div class="wf-overlay"></div>
                                                    <div class="wf-componentview">
                                                        <div class="wf-componentview-border"><label
                    ...
                    <div v-if="item.componentName=='attachmentfield'">
                        <div @mousedown="mouseDown" draggable="true" v-on:dragstart="movestart"
                             v-on:mouseout="mouseOut"
                             v-on:mouseover="hover"
                             :data-index="index"
                    ...
                    <div v-if="item.componentName=='departmentfield'">
                        <div @mousedown="mouseDown" draggable="true" v-on:dragstart="movestart"
                             v-on:mouseout="mouseOut"
                             v-on:mouseover="hover"
                             :data-index="index"
        ...
        drag.$on("moveend", function (obj) {
            ...
            if (self.InCanvas != null) {
                ...
                if (self.isDrag) {
                    ...
                    if (idx > 0) {
                        component.componentView.defaultLabel = component.componentView.defaultLabel + "（" + idx + "）";
                    }
                    if (self.InCanvas > 0) {
